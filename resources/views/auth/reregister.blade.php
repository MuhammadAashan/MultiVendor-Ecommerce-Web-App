            ...
            <div class="row m-5 " style="border-radius:62px ; background-color:gainsboro;">
                ...
                <div class="col-lg-6 col-12 text-center" style="border-top-right-radius: 60px; border-bottom-right-radius: 60px;">
                    <div>
                        ...
                        <form class="p-5" method="post"  action="{{ url('/ReRegisterSeller') }}">
                            @csrf
                            <h3>Welcome to EStore!</h3>
                            <h6 >Update as Seller Account</h6>
                            <h6 class="pb-5 text-right" ><a  href="{{ url('/') }}">GoBack to Home</a></h6>
                            <div class="row">
                               <div class="col-12">
                                    <div class="form-outline mb-4">
                                        <input id="id" type="hidden" class="form-control  name="id" value="{{auth()->user()->id }}" autocomplete="name" autofocus placeholder="Id">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-outline mb-4">
                                ...
                                <div class="col-6">
                                    <div class="form-outline mb-4">
                                        <input id="mobileno" type="mobileno" class="form-control @error('mobileno') is-invalid @enderror" name="mobileno" value="{{ auth()->user()->mobileno }}"  autocomplete="mobilno" placeholder="Mobile No">
                            ...
                            <div class="form-outline mb-4">
                                <input id="cnic" type="text" class="form-control @error('cnic') is-invalid @enderror" name="cnic" value="{{ auth()->user()->cnic }}" autocomplete="cnic" placeholder="CNIC">
                            ...
                            <div class="form-outline mb-4">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ auth()->user()->address }}"  autocomplete="address" placeholder="Address">
                            ...
                            <div class="text-center pt-1  pb-1 mr-5 ml-5">
                                <button class="btn text-light rounded-pill mb-3" type="submit" style="background-color: black;" type="submit">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
