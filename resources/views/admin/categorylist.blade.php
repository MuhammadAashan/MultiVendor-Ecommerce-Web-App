...
@section('content')
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-4  align-items-center">
                <h4 class="page-title">Main Category list</h4>
                @if ($errors->count() > 0)
            ...
            <div class="col-8 text-right">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addmodel"><i
                        class="fas fa-plus"></i> Category</button>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-5">
                            <!----Search --->
                            <form method="GET" action="{{ url('admin/categorylist') }}">
                        ...
                        <div class="table-responsive ">
                            <table class="table table-hover table-light yajra-datatable">
                                <thead class="thead-dark">
                                    <tr>
                                        <th>Category</th>
                                        <th>Description</th>
                                        <th>No of SubCategory</th>
                                        <th>See Subcategory</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                @foreach ($categorydata as $cd)
                                    <tbody>
                                        ...
                                        <td>{{ $cd->subcategory_count }}</td>
                                        <td>
                                            <form action="/admin/subcategorylist" method="post">
                                                @csrf
    ...
    <!----------------------------add Category model----------------------------->
    <form action="/admin/addm" method="post">
        @csrf
    ...
    <form action="/admin/deletem" method="post">
        @csrf
    ...
    <form action="/admin/editm" method="post">
        @csrf
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="catdesc" class="col-form-label">Category
                                Description</label>
                            <textarea class="form-control" name="catdesc" id="catdesc"></textarea>
                        </div>
                    </div>
