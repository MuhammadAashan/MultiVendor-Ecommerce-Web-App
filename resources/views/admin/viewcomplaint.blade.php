...
<div class="page-breadcrumb">
    <div class="row">
        ...
        <div class="col-6 text-right"><a href="{{url('admin/complaint')}}" class="btn btn-primary">Back</a></div>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <h5 class="text-dark">Product Price: {{$cd->Price}}</h5>
                            ...
                            <h5 class="text-dark">Seller Contact Number: {{ $cd->sellercont }}</h5>
                        </div>
                    </div>
